...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of BinarySwiftCode.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhangqian/BinarySwiftCode'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhangqian' => 'zhangqian@jlife.vip' }
  s.source           = { :git => 'https://github.com/zhangqian/BinarySwiftCode.git', :tag => s.version.to_s }
